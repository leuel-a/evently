...
export function FiltersEvent() {
    ...
    return (
        <div className="flex flex-col gap-1 md:gap-0 md:flex justify-between">
            <SearchEvents />
            <div className="relative py-8 pt-4">
                <ShowFiltersButton
                    setShowFilter={setShowFilter}
                    showFilter={showFilter}
                />
            </div>
            {/* <div className={cn(showFilter ? 'block' : 'hidden')}> */}
            <div
                className={cn(
            ...
            >
                <h3 className="text-lg font-medium border-b border-gray-200 pb-1 my-3">Filters</h3>
