...
export function CreateResourceButton() {
    ...
    const buttonLabel = `Create an ${getLabelForResource(normalizeResourceName(resource))}`;
    const createUrl = `/${DASHBOARD_PREFIX}/${resource}/create`;

    return (
        <Button className="h-12 bg-indigo-500 hover:bg-indigo-700 w-fit rounded hover:cursor-pointer">
